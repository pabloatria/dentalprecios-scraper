"""
Scraper for Dental Store (dentalstore.cl)
...
class DentalStoreScraper(BaseScraper):
    name = "Dental Store"
    base_url = "https://dentalstore.cl"
    website_url = "https://dentalstore.cl"

    api_url = "https://dentalstore.cl/wp-json/wc/store/v1/products"
    page_size = 100
