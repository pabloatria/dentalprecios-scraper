"""
Scraper for Siromax (siromax.cl)
Platform: WooCommerce + Elementor — uses WC Store API
Cloudflare protected — uses cloudscraper
Products: Dental equipment, ceramics, CAD/CAM
...
class SiromaxScraper(BaseScraper):
    name = "Siromax"
    ...
    def scrape(self) -> List[Dict]:
        ...
        while page <= 20:  # Siromax has a smaller catalog
            try:
                import time, random
