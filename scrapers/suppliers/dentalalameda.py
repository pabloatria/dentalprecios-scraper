"""
Scraper for Dental Alameda (dentalalameda.cl)
...
class DentalAlamedaScraper(BaseScraper):
    name = "Dental Alameda"
    base_url = "https://dentalalameda.cl"
    website_url = "https://dentalalameda.cl"

    api_url = "https://dentalalameda.cl/wp-json/wc/store/v1/products"
    page_size = 100
