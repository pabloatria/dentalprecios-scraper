"""
Scraper for Flamamed (flamamed.cl)
Platform: WooCommerce — uses WC Store API
Products: Aesthetic medicine (Profhilo, BCN mesotherapy, Cebelia, Velonasoft, threads)
...
class FlamamedScraper(BaseScraper):
    name = "Flamamed"
    base_url = "https://www.flamamed.cl"
    website_url = "https://www.flamamed.cl"

    api_url = "https://www.flamamed.cl/wp-json/wc/store/v1/products"
    page_size = 100
