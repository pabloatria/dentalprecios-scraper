"""
Scraper for Surdent (surdent.cl)
Platform: WooCommerce — uses WC Store API (HTML is JS-rendered)
Products: Dental materials, equipment, instruments, radiology, CAD/CAM
Prices: CLP (IVA included), publicly visible via Store API
Notable: Kuraray distributor (Panavia V5, Clearfil SE Bond)
"""
...
class SurdentScraper(BaseScraper):
    name = "Surdent"
    base_url = "https://surdent.cl"
    website_url = "https://surdent.cl"

    api_url = "https://surdent.cl/wp-json/wc/store/v1/products"
    page_size = 100
    ...
    def scrape(self) -> List[Dict]:
        ...
        while page <= 50:  # Surdent has a large catalog
            try:
                import time, random
