"""
Scraper for Dental Import (dentalimport.cl)
...
class DentalImportScraper(BaseScraper):
    name = "Dental Import"
    base_url = "https://dentalimport.cl"
    website_url = "https://dentalimport.cl"

    api_url = "https://dentalimport.cl/wp-json/wc/store/v1/products"
    page_size = 100
