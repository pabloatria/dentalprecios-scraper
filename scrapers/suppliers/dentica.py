"""
Scraper for Dentica (dentica.cl)
Platform: WooCommerce — uses WC Store API
Products: General dental supplies (~850 products)
...
class DenticaScraper(BaseScraper):
    name = "Dentica"
    base_url = "https://dentica.cl"
    website_url = "https://dentica.cl"
